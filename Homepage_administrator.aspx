        ...
        <div style="width:1590px">
            ...
            <asp:Menu ID="Menu4" runat="server" ForeColor="White" Orientation="Horizontal"  >
                <Items>
                    ...
                    <asp:MenuItem Text="Modificarea rapoartelor" Value="Modificarea rapoartelor" NavigateUrl ="~/Modificarea_rapoartelor.aspx"></asp:MenuItem>
                    <asp:MenuItem Text="Incasari" Value="Incasari" NavigateUrl ="~/Incasari.aspx"></asp:MenuItem>
                ...
                <StaticMenuItemStyle HorizontalPadding="81px" VerticalPadding="20px" ForeColor="White" />
