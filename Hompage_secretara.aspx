        ...
        <div style="width:1590px">
            ...
            <asp:Menu ID="Menu3" runat="server" ForeColor="White" Orientation="Horizontal"  >
                <Items>
                    ...
                    <asp:MenuItem Text="Rapoarte" Value="Rapoarte" NavigateUrl ="~/Rapoarte.aspx"></asp:MenuItem>
                    <asp:MenuItem Text="Contabilitate" Value="Contabilitate" NavigateUrl ="~/Contabilitate.aspx"></asp:MenuItem>
                ...
                <StaticMenuItemStyle HorizontalPadding="108px" VerticalPadding="20px" ForeColor="White" />
