        ...
        <div style="width:1590px">
            ...
            <asp:Menu ID="Menu1" runat="server" ForeColor="White" Orientation="Horizontal"  >
                <Items>
                    ...
                    <asp:MenuItem Text="Foaie consult" Value="Foaie consult" NavigateUrl ="~/Foaie_consult.aspx"></asp:MenuItem>
                    <asp:MenuItem Text="Trimitere" Value="Trimitere" NavigateUrl ="~/Trimitere.aspx"></asp:MenuItem>
                    <asp:MenuItem Text="Scrisoarea medicala" Value="Scrisoare medicala" NavigateUrl ="~/Scrisoare_medicala.aspx"></asp:MenuItem>
                ...
                <StaticMenuItemStyle HorizontalPadding="85px" VerticalPadding="20px" ForeColor="White" />
